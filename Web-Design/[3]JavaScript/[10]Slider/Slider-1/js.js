 ...
 // mainImage.setAttribute('src','img/img%20(3).jpg');
 ...
 img4.onclick = function () {
     var img4Src = document.getElementById('img4').getAttribute('src');
     document.getElementById('mainImage').setAttribute('src',img4Src);
